...
import mrcabbagestick.electrify.content.wires.SteelWireItem;
...
public class ElectrifyItems {
    ...
    public static final Item STEEL_WIRE = registerItem(new SteelWireItem(new FabricItemSettings()), "steel_wire");
